...
Imposta "aderenza.aderente" a true SOLO se ogni fatto, sintassi o esempio specifico nella bozza trova riscontro in uno degli estratti forniti. Imposta "aderenza.aderente" a false se anche una sola sezione descrive dettagli non presenti negli estratti (segno che sono stati scritti a memoria invece che dalle fonti). Se aderente è false, "aderenza.motivi" deve indicare in modo specifico e azionabile quale affermazione non è supportata e da quale sezione proviene, un motivo per riga, massimo una frase ciascuno.`;
}
