...
// ridurre o omettere.
function buildIntroLevelInstruction(topic) {
    return `Chi legge sta usando "${topic}" per la prima volta oggi, in un progetto normale: non sa nulla oltre a quello che scrivi in questo appunto, e il tuo unico obiettivo è farglielo usare correttamente in un caso comune. Scrivi solo:
- cos'è e a cosa serve "${topic}", con parole semplici;
...
export { buildIntroLevelInstruction };
